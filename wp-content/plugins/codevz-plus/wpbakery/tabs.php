		...
		$settings = array(
			...
			'params'		=> array(
				...
				array(
					...
					"heading"     	=> esc_html__( "Active Subtitle", 'codevz'),
					'button' 		=> esc_html__( "Active Subtitle", 'codevz'),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'color', 'background', 'border' )
				),
				...
				array(
					...
					"heading"     	=> esc_html__( "Active Icons", 'codevz'),
					'button' 		=> esc_html__( "Active Icons", 'codevz'),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'color', 'font-size', 'background', 'border' )
				),
