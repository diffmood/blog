			...
			'params'		=> array(
				...
				array(
					...
					'value'			=> array(
						...
						esc_html__( 'Icon Move Up', 'codevz') 		=> 'cz_btn_icon_move_up',
						esc_html__( 'Icon Move Down', 'codevz') 	=> 'cz_btn_icon_move_down',
						esc_html__( 'Icon Move Right', 'codevz') 	=> 'cz_btn_icon_move_right',
						esc_html__( 'Icon Move Left', 'codevz') 	=> 'cz_btn_icon_move_left',
