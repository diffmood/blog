	...
	if ( $( '.wp-customizer' ).length ) {
		...
		function checkCustomTemplateOptions( option ) {
			...
			var active 		= 'codevz-section-disabled',
					...
					sections 	= option === 'header_elementor' ? $( '#accordion-section-codevz_theme_options-header_logo, #accordion-section-codevz_theme_options-header_1, #accordion-section-codevz_theme_options-header_2, #accordion-section-codevz_theme_options-header_3, #accordion-section-codevz_theme_options-mobile_header' ) : $( '#accordion-section-codevz_theme_options-footer_1, #accordion-section-codevz_theme_options-footer_2, #accordion-section-codevz_theme_options-footer_widgets' ); 
